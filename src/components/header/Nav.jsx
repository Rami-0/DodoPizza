		...
		<div className={`${css.wrapper} ${isSticky ? css.show : ""}`}>
			<nav className={css.nav}>
				<div className={css.linksWrapper}>
					<ul className={isSticky ? css.showTransform : ""}>
						<span className={css.icon}>
							<img id={css.svg} className={isSticky ? css.showTransform : ""} src={logo} alt="" />
							{/* <svg
								...
								viewBox="0 0 70 70">
								<path
									className={isSticky ? css.showTransform : ""}
						...
						<li>
							<a className={css.anchorLinks} href="#Комбо">
								Комбо
							</a>
						</li>
						<li>
							<a className={css.anchorLinks} href="#Закуски">
								Закуски
							</a>
						</li>
						<li>
							<a className={css.anchorLinks} href="#Десерты">
								Десерты
							</a>
						</li>
						<li>
							<a className={css.anchorLinks} href="#Напитки">
								Напитки
							</a>
						</li>
						<li>
							<a className={css.anchorLinks} href="#Акции">
								Акции
							</a>
						</li>
						<li>
